...
if __name__ == "__main__":
    ...
    eval('/workspaces/Poly-MOT/jittering_module/data/edgarscenes_tracking_result_PRC_z_test_XYmin_2ess1.json', '/workspaces/Poly-MOT/paper/edgarscenes_jitter', '/workspaces/Poly-MOT/dataset/edgarscenes', 'val')